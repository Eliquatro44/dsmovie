...
public class MovieController { // Corrigido o nome da classe
	...
	public MovieDTO findById(@PathVariable Long id) {
		return service.findById(id); // Agora este método usará a implementação de MovieService
	}
 ...
 * public MovieDTO saveScore(@RequestBody ScoreDTO dto) { return
 * service.saveScore(dto);
 * 
 * @PutMapping // public MovieDTO saveScore(@RequestBody ScoreDTO dto) { return
 * null; }
 */
